...
La prima domanda di design è stata: *esiste un servizio esterno che, data una RAL, restituisce il netto?*
...
2. **Le addizionali sono a conguaglio sfalsato**: quelle maturate nell'anno *n* sono trattenute
   in 11 rate nell'anno *n+1*, più l'acconto (30%) del comunale dell'anno *n*.
...
fascia, confondendola con la *no-tax area* introdotta dalla riduzione del cuneo. Da dirimere sul testo
...
> superamento"** (aliquota applicata all'*intero* imponibile in base allo scaglione di appartenenza),
